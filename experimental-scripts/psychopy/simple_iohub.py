...
From simple.py in PsychoPy
Adapted by Esperanza Badaya
Date: 30/08/2024
"""
...
local_edf = os.path.join(results_folder, edf_file) 
...
if TRACKER == 'mouse':
    ...
    eyetracker_config['calibration'] = dict(screen_background_color=BACKGROUND_COLOR)
    eyetracker_config['default_native_data_file_name'] = local_edf
